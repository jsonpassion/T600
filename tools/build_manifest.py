...
from kit import BANDS, CONFIG, ROOT, parse_frontmatter, unit_files
...
def main() -> int:
    ...
    if "--check" in sys.argv:
        ...
        print("manifest.json is up to date" if ok else "manifest.json is stale — run tools/build_manifest.py")
