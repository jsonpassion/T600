...
`content/voca/score-327-452/unit-001.md`에 쓴다. 표제어를 바꾸거나 빼거나 더하지 않는다 — 다른 권과의 중복은 이미 제거되어 있다.

## 이 권
- band_id `score-327-452` (327-452, 중급) · unit 001 · 테마: 비즈니스 소통 — 이메일·일정·협상 콜로케이션
...
44. bargaining power
45. compromise
46. make a concession
47. leverage
48. stakeholder
49. submit a proposal
50. turn down
51. back out of
52. hold out for
53. come to terms with
...
75. representative
76. delegation
77. mutually beneficial
78. persuade
79. objection
80. have reservations about
81. tactful
82. diplomatic
83. courteous
84. enclose
...
88. get across
89. put forward
90. take into account
91. take note of
92. bear in mind
93. drop someone a line
94. put through
95. call back
96. leave a message
97. voicemail
98. get to the point
99. beat around the bush
100. cut to the chase

## 저장 전 스스로 확인
① 100줄인가 ② 모든 줄이 6필드인가 ③ 배정표와 표제어가 정확히 같은가 ④ IPA가 `/…/`인가
⑤ TIP이 45자 이내이고 뜻의 반복이 아닌가 ⑥ 예문에 표제어가 들어 있는가.
저장 후 `python3 tools/validate_content.py --unit score-327-452/001` 를 실행해 0 errors가 될 때까지 해당 줄만 고친다.
