...
육공공(이하 "앱")은 텝스(TEPS) 시험 대비 영어 어휘 학습을 돕기 위해 독립적으로 개발된 iOS 애플리케이션입니다. 앱은 서울대학교 TEPS관리위원회와 무관합니다. 앱은 레벨(점수대)별 학습 콘텐츠를 제공하며, 레벨은 ~326, 327-452, 453-525, 526-600의 네 점수대(New TEPS 공인 등급 기준). 각 레벨의 단어는 생물학, 천문학, 물리학처럼 학문 주제별 책으로 묶여 있고, 첫 주제 책은 무료로, 나머지 주제 책은 앱 내 구매(이용권)를 통해 이용할 수 있습니다.
