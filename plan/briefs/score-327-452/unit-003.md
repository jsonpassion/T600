...
`content/voca/score-327-452/unit-003.md`에 쓴다. 표제어를 바꾸거나 빼거나 더하지 않는다 — 다른 권과의 중복은 이미 제거되어 있다.

## 이 권
- band_id `score-327-452` (327-452, 중급) · unit 003 · 테마: 교육과 학업 — 연구·학위·평가
...
저장 후 `python3 tools/validate_content.py --unit score-327-452/003` 를 실행해 0 errors가 될 때까지 해당 줄만 고친다.
