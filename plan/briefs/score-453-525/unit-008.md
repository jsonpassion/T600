# 2단계 — TEPS 중상급 008권 작성

너는 텝스(TEPS) 어휘 교재 저자다. 아래 **배정된 100개 표제어만** 사용해 앱이 읽는 단어책 파일 하나를
`content/voca/score-453-525/unit-008.md`에 쓴다. 표제어를 바꾸거나 빼거나 더하지 않는다 — 다른 권과의 중복은 이미 제거되어 있다.

## 이 권
- band_id `score-453-525` (453-525, 중상급) · unit 008 · 테마: 논증과 태도 — 주장·반박·양보의 문어 어휘
...
93. beg the question
94. split hairs
95. a double-edged sword
96. on the fence
97. the other side of the coin
98. counterargument
99. concession
100. contention
...
저장 후 `python3 tools/validate_content.py --unit score-453-525/008` 를 실행해 0 errors가 될 때까지 해당 줄만 고친다.
